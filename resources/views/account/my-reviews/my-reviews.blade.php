                    ...
                    <div class="card-body pb-0">
                        <div class="d-flex justify-content-end">
                            <form action="" method="get">
                                <div class="d-flex ">
                                    <input type="text" class="form-control w-auto" value="{{ Request::get('keyword') }}"
                                    ...
                                    @foreach ($reviews as $review)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0);" onclick="deleteReview({{ $review->id }});" class="btn btn-danger btn-sm"><i
