            ...
            <div class="row mt-4">
                ...
                <div class="col-md-8">
                    ...
                    <div class="star-rating d-inline-flex ml-2" title="">
                       ...
                       <span class="theme-font text-muted">({{ ($book->reviews_count > 1 ) ? $book->reviews_count.
                                         'Reviews' : $book->reviews_count.'Review' }} )</span>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4 col-lg-4 mb-4">
                            ...
                            @endphp
                                ...
                                <div class="card-body">
                                    <h3 class="h4 heading"> <a href="{{ route("book.detail",$relatedBook->id) }}"></a>{{ $relatedBook->title }}</h3>
                                    ...
                                    <div class="star-rating d-inline-flex ml-2" title="">
                                        ...
                                        <div class="star-rating d-inline-flex mx-2" title="">
                                         ...
                                         <span class="theme-font text-muted">({{ ($relatedBook->reviews_count > 1 ) ? $relatedBook->reviews_count.
                                         'Reviews' : $relatedBook->reviews_count.'Review' }} )</span>
                                    </div>
                                </div>
                            </div>
                        </div>
